...
- **Registrasi baru**: Paket Basic gratis **14 hari trial**
- Setelah 14 hari: **wajib upgrade ke Pro** (minimal Rp 99.000/bulan) untuk melanjutkan
...
|-------|--------|------|-------------|-------|
| **Basic** | 1 | 2 (Owner + Kasir) | Gratis | POS Dasar, Laporan Sederhana |
